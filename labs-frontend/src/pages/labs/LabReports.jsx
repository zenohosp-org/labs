...
/** Completed lab reports — REPORT_GENERATED + BILLED (server-side alias). */
function LabReports() {
    const { user } = useAuth();
        ...
        <div className="hms-rad-page">
            <div className="hms-rad-page__head">
                <div>
                    ...
                    <p className="hms-rad-page__sub">View and manage completed pathology reports</p>
                </div>
